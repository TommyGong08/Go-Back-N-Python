...
class Config:
    def __init__(self):
        ...
        self.host1_port = 9998                                 # host1的端口
        self.host1_addr = (self.ip, self.host1_port)          # host1地址
        self.host2_port = 9999                                   # host2端口
        self.host2_addr = (self.ip, self.host2_port)              # host2地址
        ...
        self.send_log = self.send_file + '.host1.log'     # 发送方日志
        self.recv_file = 'host1_recv.pdf'           # 接受后写入的文件
